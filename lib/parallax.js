...
var main = function () {
    ...
    billboards.push(new ImageBillboard_1["default"]('images/beach.jpg', -(width / 15), -(width / 50), 10, width, width / 1.6));
    billboards.push(new ImageBillboard_1["default"]('images/cloud.png', -50, 100, 3, width, width / 1.5));
    billboards.push(new ImageBillboard_1["default"]('images/cloud.png', -800, -100, 1, width, width / 1.5));
    billboards.push(new ImageBillboard_1["default"]('images/cloud.png', 200, 200, 3, width, width / 1.5));
    Renderer_1["default"]('context', width, width / 1.6, billboards);
};
main();
...
exports.__esModule = true;
var Tracker_1 = __webpack_require__(3);
...
var ImageBillboard = /** @class */ (function () {
    ...
    ImageBillboard.prototype.updateTracking = function () {
        var _this = this;
        var SPEED = 10.0;
        var moveField = function (field) {
            _this.currentAcceleration[field] += (Tracker_1["default"][field] - _this.currentAcceleration[field]) / SPEED;
        };
        moveField('x');
        moveField('y');
    ...
    ImageBillboard.prototype.render = function (context) {
        var _this = this;
        var addOrientation = function (field, invert) {
            if (invert === void 0) { invert = 1; }
            return (_this.currentAcceleration !== undefined ? ((_this.currentAcceleration[field] * invert) * ACCELERATION_FACTOR / (DISTANCE_FACTOR * _this.z)) : 0);
        };
        context.drawImage(this.image, this.x + addOrientation('x'), this.y + addOrientation('y', -1), this.width, this.height);
    };
...
tracking.ViolaJones.classifiers.face = face_1["default"];
